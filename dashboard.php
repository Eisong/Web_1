  ...
  <body>
    ...
    <!-- About Start -->
         ...
         <div class="row puss">
             <div class="container">
             	<div class="col-sm-12">
                <img class="img-responsive  " src="images/bg/gps.jpg" draggable="false" alt="cow">
              </div>
              <div class="col-sm-12">
                   ...
                   <h2 class="text-center">Set Co-ordinates</h2>
					  ...
					  <div class="col-sm-6">
						<div class="form-group">
						  <input type="text" id="name" class="form-control" placeholder="Longitude" name="uname">
						 </div>
                        </div>
								
                       <div class="col-sm-6">
					    <div class="form-group">
						 <input type="text" id="passs" class="form-control" placeholder="Latitude" name="pass" >
						 </div>
